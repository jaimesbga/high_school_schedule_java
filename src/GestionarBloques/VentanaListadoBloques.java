...
public class VentanaListadoBloques {
	...
	public VentanaListadoBloques(JDesktopPane desktopPane){
		getVentana();
	...
	public JInternalFrame getVentana() {
		if (ventana == null) {
			...
			ventana.setTitle("Listado de bloques");
